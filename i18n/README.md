...
```bash
python3 -m unittest -v test_8_app_unittest.py
```
```bash
(.venv) root@UID7E:/mnt/d/Users/steph/Documents/5ème_trimestre/holbertonschool-we
b_back_end/i18n# python3 -m unittest -v test_8_app_unittest.py
test_bad_timezone_fallback_utc (test_8_app_unittest.Step8CurrentTimeTestCase) ...
 [SELECTORS] query={'timezone': 'NotAZone'} -> locale='en', timezone='UTC'
ok
test_force_fr_paris (test_8_app_unittest.Step8CurrentTimeTestCase) ... [SELECTORS] query={'locale': 'fr', 'timezone': 'Europe/Paris'} -> locale='fr', timezone='Europe/Paris'
ok
test_login_as_1_fr_paris (test_8_app_unittest.Step8CurrentTimeTestCase) ... [SELECTORS] query={'login_as': '1'} -> locale='fr', timezone='Europe/Paris'
ok
test_login_as_2_en_us_central (test_8_app_unittest.Step8CurrentTimeTestCase) ... [SELECTORS] query={'login_as': '2'} -> locale='en', timezone='US/Central'
ok

----------------------------------------------------------------------
Ran 4 tests in 0.454s
